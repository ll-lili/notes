...
> @types是一个TS官方的类型库，其中包含多少对js代码的类型描述
...
- 定义一个枚举：
  ...
  function print () {
      Object.values(Gender).forEact(val => consoel.log(val))
  }
  ```

> 枚举会出现子啊编辑结果中，编译结果中表现为对象
